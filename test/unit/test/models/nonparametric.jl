...
@testset "model_loglike(model, noise_var_priors, data)" begin
    ...
    @param_test BOSS.model_loglike begin
        ...
        @success (
            out isa Function,
            out(Float64[], [1.;1.;; 1.;1.;;], [1., 1.]) isa Real,
            out(Float64[], [1.;1.;; 1.;1.;;], [1., 1.]) < 0.,
            out(Float64[], [1.;1.;; 1.;1.;;], [5., 5.]) > out(Float64[], [1.;1.;; 1.;1.;;], [100., 100.]),
            out(Float64[], [5.;5.;; 5.;5.;;], [1., 1.]) > out(Float64[], [100.;100.;; 100.;100.;;], [1., 1.]),
        )
    end
end
