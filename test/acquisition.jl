...
@testset "EI with LinFitness" begin
    ...
    @test BOSS.expected_improvement(fitness, mean, var, ϵ_samples, best_yet) ≈ 12.000000015720124 atol=1e-8
end
...
@testset "EI with NonlinFitness" begin
    ...
    @test BOSS.expected_improvement(fitness, mean, var, ϵ, best_yet) ≈ 0.13679782913530203 atol=1e-8
    @test BOSS.expected_improvement(fitness, mean, var, ϵ_samples, best_yet) ≈ 0.10216139253430176 atol=1e-8
end
